...
import { HolidayType, PlaceDto, PlaceForm, Seasons } from '../interfaces/places-interfaces';
  ...
  export class PlacesEditPage {
    ...
    private _setForm() {
        this.placeEditForm = new FormGroup ({
            ...
            country: new FormControl(this.selectedPlace?.country, Validators.required),
            city: new FormControl(this.selectedPlace?.city,Validators.required),
            favoriteSeason: new FormControl(this.selectedPlace?.favoriteSeason.toString(),Validators.required),
            typeHoliday: new FormControl(this.selectedPlace?.typeHoliday.toString(), Validators.required),
          ...
          this.placeEditForm.valueChanges.subscribe((form: PlaceForm) => console.log(form));
    }
    ...
    submitForm() {
        ...
        const newDto:PlaceDto = {
            ...formValues,
            favoriteSeason: formValues.favoriteSeason? +formValues.favoriteSeason : 0,

  ...
  private _setForm() {
    this.userEditForm = new FormGroup({
      ...
      residence: new FormControl(
        this.selectedUser?.residence,
        Validators.required
      ),
      favoriteTypeHoliday: new FormControl(
        this.selectedUser?.favoriteTypeHoliday
      ),
      favoritePlace: new FormControl(this.selectedUser?.favoritePlace),
    });

    this.userEditForm.valueChanges.subscribe((form: UserForm) =>
      console.log(form)
    );
  }
